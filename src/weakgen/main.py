...
weak_form_object = Weak_form(equation = None, trial_function_name="u", test_function_name="v", vector_trial_fuction_name="u_vec", vector_test_function_name="v_vec", string_equation="div(grad(u*2))= f", boundary_condition=Boundaries.neumann, boundary_function="g")
